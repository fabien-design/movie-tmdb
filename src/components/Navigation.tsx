...
const Navigation: React.FC<NavigationProps> = ({ searchMethod, searchedMovies }) => {
          ...
          <div className="flex">
            <div className="flex-shrink-0 flex items-center">
              ...
              <Link to="/" className="flex items-center" onClick={closeMenus}>
                ...
                <span className="ml-2 text-xl font-bold text-white hidden sm:block">MovieDB</span>
              </Link>
            </div>
                  ...
                  {searchedMovies.length > 0 ? (
                    <>
                      <div className="p-2 border-b border-gray-700">
                        <h3 className="text-gray-300 text-sm font-semibold">Résultats ({searchedMovies.length})</h3>
                      </div>
                      <ul>
                        ...
                        {searchedMovies.length > 5 && (
                          <li className="p-2 text-center">
                            <Link 
                              ...
                              onClick={() => setShowResults(false)}
                            >
                              Voir tous les résultats ({searchedMovies.length})
                            </Link>
                          </li>
                        )}
                      </ul>
                    ...
                    <div className="p-4 text-center text-gray-400">
                      {loadingMovies && searchQuery.trim() !== '' ? (
                        "Recherche en cours..."
                      ) : (
                        searchQuery.trim() !== '' ? (
